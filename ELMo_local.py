...
from model_bilinear_elmo_global import Local_Coherence_Score, BiAffine, BiAffine_1, Save_Model_State, \
    AdaptivePairwiseLoss, AdaptivePairwiseLoss_v2, ELMo_Layer, ELMo_Sentence_Embedding, DynamicConv4
...
criterion = AdaptivePairwiseLoss_v2(margin=args.ranking_loss_margin, device=args.device)
