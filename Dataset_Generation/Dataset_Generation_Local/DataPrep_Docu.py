...
def Parse_Args():
    ...
    parser.add_argument('--train_pos', type=str, default="./text_train/pos_text/", help='Pos Train file dir path')
    parser.add_argument('--train_neg', type=str, default="./text_train/neg_text/", help='Neg Train file dir path')
    parser.add_argument('--test_pos', type=str, default="./text_test/pos_text/", help='Pos Test file dir path')
    parser.add_argument('--test_neg', type=str, default="./text_test/neg_text/", help='Pos Test file dir path')
    parser.add_argument('--val_pos', type=str, default="./val/", help='Pos valid file dir path')
    parser.add_argument('--val_neg', type=str, default="./val/", help='Neg valid file dir path')
